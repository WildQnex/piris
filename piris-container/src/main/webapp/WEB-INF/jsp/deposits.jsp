                ...
                <c:forEach items="${deposits}" var="deposit">
                    <li>
                        <div class="collapsible-header">
                            <a>Deposit contract number: &nbsp</a> ${deposit.number} &nbsp|&nbsp  <c:choose>
                                                        <c:when test="${deposit.isRevocable()}">
                                                            Revocable
                                                        </c:when>
                                                        <c:otherwise>
                                                            None revocable
                        ...
                        <div class="collapsible-body">
                            <a>Money:&nbsp</a> ${deposit.money} <c:choose>
                                             <c:when test="${deposit.isDollar()}">
                                                 $
                                             </c:when>
                                             <c:otherwise>
                                                 p.
