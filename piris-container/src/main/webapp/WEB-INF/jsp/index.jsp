        ...
        <div class="row">
            ...
            <div class="input-field col s4 m4">
                <select id="disability" name="disability">
                    <option selected
                            value=${client.disabilityDegree.id} disabled>${client.disabilityDegree.disabilityDegree}</option>
            ...
            <div class="input-field col s4 m4">
                <select id="meritalStatus"  required>
                    <option selected
                            value=${client.meritalStatus.id} disabled>${client.meritalStatus.status}</option>
