...
<div class="container">
    <form class="col s12" method="POST" action="/api/clients" modelAttribute="client">
        <div class="row">
            <div class="input-field offset-s4 offset-m4 col s4 m4">
                <input id="idView" type="text" name="idView" class="validate" required disabled
                       pattern="[0-9]{1,20}" value="${client.id}"
                       title="id">
                <label for="idView">Client id</label>
            </div>
        </div>
        ...
        <div style="text-align: center" class="row">
            <a href="/api/clients" class="btn amber accent-4 amber accent-4 waves-effect waves-light"
                Back
            </a>
            <button class="btn amber accent-4 amber accent-4 waves-effect waves-light" type="submit">
                Update
            </button>
        </div>
    </form>
